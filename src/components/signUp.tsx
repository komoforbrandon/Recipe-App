...
export default function SignUp() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-4 bg-linear-to-t from-gray-100/70 via-black/10 to-gray-200/14 rounded-2xl shadow-2xl p-6">
      <div className="p-8 rounded-lg w-full ">
        ...
        <div className="space-y-4 gap-3 w-full flex md:flex-row flex-col">
            <input type="email" placeholder="email@address.com" className="w-full py-3 px-4 border bg-white border-gray-300 rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500" />
      ...
      <div className="bg-gray/10 border-8 border-white p-4 pb-12 rounded-[2.5rem] shadow-xl rotate-[-4deg] max-w-sm">
        <img src={Imghero}
